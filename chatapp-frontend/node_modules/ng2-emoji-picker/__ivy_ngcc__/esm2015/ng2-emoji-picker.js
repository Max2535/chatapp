import { Component, ComponentFactoryResolver, Directive, ElementRef, EventEmitter, Injectable, Input, NgModule, Output, Pipe, Renderer2, ViewChild, ViewChildren, ViewContainerRef, forwardRef } from '@angular/core';
...
function EmojiButtonComponent_button_0_Template(rf, ctx) { if (rf & 1) {
    const _r4 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "button", 2);
    ɵngcc0.ɵɵlistener("click", function EmojiButtonComponent_button_0_Template_button_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r4); const ctx_r3 = ɵngcc0.ɵɵnextContext(); return ctx_r3.selectionEmitter.emit(ctx_r3.dataToEmit || ctx_r3.emoji); });
    ɵngcc0.ɵɵtext(1);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r0 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r0.emoji[0], "\n");
} }
function EmojiButtonComponent_ng_template_1_Template(rf, ctx) { if (rf & 1) {
    const _r6 = ɵngcc0.ɵɵgetCurrentView();
    ɵngcc0.ɵɵelementStart(0, "span", 3);
    ɵngcc0.ɵɵlistener("click", function EmojiButtonComponent_ng_template_1_Template_span_click_0_listener() { ɵngcc0.ɵɵrestoreView(_r6); const ctx_r5 = ɵngcc0.ɵɵnextContext(); return ctx_r5.selectionEmitter.emit(ctx_r5.dataToEmit || ctx_r5.emoji); });
    ɵngcc0.ɵɵelement(1, "span", 4);
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r2 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵstyleProp("background-image", "url(" + ctx_r2.emojiPickerOptions.options.sheet.url + ")")("background-position-x", -ctx_r2.emojiPickerOptions.options.sheet.locator(ctx_r2.emoji[1]).x * 25 + "px")("background-position-y", -ctx_r2.emojiPickerOptions.options.sheet.locator(ctx_r2.emoji[1]).y * 25 + "px");
} }
...
EmojiPickerOptions.ɵfac = function EmojiPickerOptions_Factory(t) { return new (t || EmojiPickerOptions)(); };
EmojiPickerOptions.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: EmojiPickerOptions, factory: EmojiPickerOptions.ɵfac });
/** @nocollapse */
EmojiPickerOptions.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiPickerOptions, [{
        type: Injectable
...
class CaretEvent {
    ...
    static compare(e1, e2) {
        const /** @type {?} */ changed = /** different when either caretRange is omitted while other exists */
    ...
    static generateCaretEvent(win, doc, element) {
        let /** @type {?} */ caretOffset = 0;
        let /** @type {?} */ sel;
        let /** @type {?} */ caretRange;
        const /** @type {?} */ textContent = element.textContent;
        ...
        if (typeof win.getSelection !== "undefined") {
            ...
            if (sel.rangeCount > 0) {
                const /** @type {?} */ range = win.getSelection().getRangeAt(0);
                const /** @type {?} */ preCaretRange = range.cloneRange();
                const /** @type {?} */ nodeLength = element.textContent.length;
            ...
            const /** @type {?} */ textRange = sel.createRange();
            const /** @type {?} */ preCaretTextRange = doc.body.createTextRange();
...
class EmojiButtonComponent {
    /**
     * @param {?} emojiPickerOptions
     */
    constructor(emojiPickerOptions) {
        this.emojiPickerOptions = emojiPickerOptions;
        this.selectionEmitter = new EventEmitter();
    }
}
EmojiButtonComponent.ɵfac = function EmojiButtonComponent_Factory(t) { return new (t || EmojiButtonComponent)(ɵngcc0.ɵɵdirectiveInject(EmojiPickerOptions)); };
EmojiButtonComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiButtonComponent, selectors: [["emoji-button"]], inputs: { emoji: "emoji", dataToEmit: "dataToEmit", options: "options", fitzpatrick: "fitzpatrick" }, outputs: { selectionEmitter: "selection" }, decls: 3, vars: 2, consts: [["class", "emoji-button", 3, "click", 4, "ngIf", "ngIfElse"], ["sheetButton", ""], [1, "emoji-button", 3, "click"], [1, "emoji-button-from-sheet-enclosure", 3, "click"], [1, "emoji-button-from-sheet"]], template: function EmojiButtonComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵtemplate(0, EmojiButtonComponent_button_0_Template, 2, 1, "button", 0);
        ɵngcc0.ɵɵtemplate(1, EmojiButtonComponent_ng_template_1_Template, 2, 6, "ng-template", null, 1, ɵngcc0.ɵɵtemplateRefExtractor);
    } if (rf & 2) {
        const _r1 = ɵngcc0.ɵɵreference(2);
        ɵngcc0.ɵɵproperty("ngIf", !ctx.emojiPickerOptions.options.sheet)("ngIfElse", _r1);
    } }, directives: [ɵngcc1.NgIf], styles: ["[_nghost-%COMP%] {  display: inline-block; }.emoji-button[_ngcontent-%COMP%] {  padding: 0;  outline: none;  background: none;  cursor: pointer;  width: 34px;  height: 34px;  border: 5px solid transparent;  border-radius: 3px;  font-size: 24px;  line-height: 1.1;  transition: all 0.2s; }  .emoji-button[_ngcontent-%COMP%]:hover, .emoji-button[_ngcontent-%COMP%]:focus {    background: #F1F1F1;    border-color: #F1F1F1; }.emoji-button-from-sheet[_ngcontent-%COMP%] {  padding: 0;  border: none;  outline: none;  display: inline-block;  background-repeat: no-repeat;    box-shadow: 0 0 1px 1px white inset;  background-size: 1225px;  width: 25px;  height: 25px; }.emoji-button-from-sheet-enclosure[_ngcontent-%COMP%] {  display: inline-block;  cursor: pointer;  line-height: 0;  padding: 4.5px;  border-radius: 3px; }  .emoji-button-from-sheet-enclosure[_ngcontent-%COMP%]:hover, .emoji-button-from-sheet-enclosure[_ngcontent-%COMP%]:focus {    background: #F1F1F1;    border-color: #F1F1F1; }    .emoji-button-from-sheet-enclosure[_ngcontent-%COMP%]:hover   .emoji-button-from-sheet[_ngcontent-%COMP%], .emoji-button-from-sheet-enclosure[_ngcontent-%COMP%]:focus   .emoji-button-from-sheet[_ngcontent-%COMP%] {      box-shadow: 0 0 1px 1px #F1F1F1 inset; }"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiButtonComponent, [{
        type: Component,
        args: [{
                selector: 'emoji-button',
                styles: [':host {  display: inline-block; }.emoji-button {  padding: 0;  outline: none;  background: none;  cursor: pointer;  width: 34px;  height: 34px;  border: 5px solid transparent;  border-radius: 3px;  font-size: 24px;  line-height: 1.1;  transition: all 0.2s; }  .emoji-button:hover, .emoji-button:focus {    background: #F1F1F1;    border-color: #F1F1F1; }.emoji-button-from-sheet {  padding: 0;  border: none;  outline: none;  display: inline-block;  background-repeat: no-repeat;  /** box shaddowing the edges until I find a better sprite sheet */  box-shadow: 0 0 1px 1px white inset;  background-size: 1225px;  width: 25px;  height: 25px; }.emoji-button-from-sheet-enclosure {  display: inline-block;  cursor: pointer;  line-height: 0;  padding: 4.5px;  border-radius: 3px; }  .emoji-button-from-sheet-enclosure:hover, .emoji-button-from-sheet-enclosure:focus {    background: #F1F1F1;    border-color: #F1F1F1; }    .emoji-button-from-sheet-enclosure:hover .emoji-button-from-sheet, .emoji-button-from-sheet-enclosure:focus .emoji-button-from-sheet {      box-shadow: 0 0 1px 1px #F1F1F1 inset; }'],
                template: `
<button
...
<ng-template #sheetButton>
  ...
  `
    ...
    }], function () { return [{ type: EmojiPickerOptions }]; }, { selectionEmitter: [{
            type: Output,
            args: ['selection']
        }], emoji: [{
            type: Input,
...
EmojiCategoryComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiCategoryComponent, selectors: [["emoji-category"]], inputs: { category: "category" }, decls: 2, vars: 1, consts: [[1, "emoji-category"]], template: function EmojiCategoryComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiCategoryComponent, [{
        type: Component,
        args: [{
...
EmojiListComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiListComponent, selectors: [["emoji-list"]], viewQuery: function EmojiListComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(EmojiCategoryComponent, 5);
    } if (rf & 2) {
        let _t;
    ...
    } }, directives: function () { return [ɵngcc1.NgForOf, EmojiCategoryComponent, EmojiButtonComponent]; }, pipes: function () { return [EmojiEmptyCategoryPipe]; }, styles: ["[_nghost-%COMP%] {  overflow-y: auto; }.emoji-list[_ngcontent-%COMP%] {  padding: 0 10px 10px; }.emoji-buttons[_ngcontent-%COMP%] {  display: flex;  justify-content: center;  flex-wrap: wrap;  margin: 5px 0; }"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiListComponent, [{
        type: Component,
        args: [{
                selector: 'emoji-list',
...
class EmojiContentComponent {
     ...
     */
    searchHandler(value) {
        let /** @type {?} */ filteredEmojis = this.emojisCategories.map((category) => Object.assign({}, category, { emojis: [] }));
        value = value.replace(/-/g, '').toLowerCase();
        Object.keys(this._emojis).forEach((i) => {
            const /** @type {?} */ category = this._emojis[i];
...
EmojiContentComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiContentComponent, selectors: [["emoji-content"]], viewQuery: function EmojiContentComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(EmojiListComponent, 5);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.emojiListComponent = _t.first);
    } }, inputs: { inputAutofocus: "inputAutofocus" }, outputs: { emojiSelectionEmitter: "emoji-selection" }, decls: 3, vars: 3, consts: [[3, "emojisCategories", "inputAutofocus", "categorySelection", "search"], [3, "emojis", "emoji-selection"]], template: function EmojiContentComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵproperty("emojisCategories", ctx.emojisCategories)("inputAutofocus", ctx.inputAutofocus);
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("emojis", ctx.emojis);
    } }, directives: function () { return [EmojiHeaderComponent, EmojiListComponent, EmojiFooterComponent]; }, styles: ["[_nghost-%COMP%] {  display: flex;  flex-direction: column;  width: 100vw;  height: 314px;  border-radius: 3px;  background: #FFF;  text-align: left;  box-shadow: 0 11px 15px -7px rgba(0, 0, 0, 0.2), 0 24px 38px 3px rgba(0, 0, 0, 0.14), 0 9px 46px 8px rgba(0, 0, 0, 0.12); }  @media (min-width: 258px) {    [_nghost-%COMP%] {      width: 258px; } }emoji-list[_ngcontent-%COMP%] {  flex-grow: 1; }"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiContentComponent, [{
        type: Component,
        args: [{
                selector: 'emoji-content',
                styles: [':host {  display: flex;  flex-direction: column;  width: 100vw;  height: 314px;  border-radius: 3px;  background: #FFF;  text-align: left;  box-shadow: 0 11px 15px -7px rgba(0, 0, 0, 0.2), 0 24px 38px 3px rgba(0, 0, 0, 0.14), 0 9px 46px 8px rgba(0, 0, 0, 0.12); }  @media (min-width: 258px) {    :host {      width: 258px; } }emoji-list {  flex-grow: 1; }'],
                template: `
  <emoji-header 
  ...
  `
            ...
            type: ViewChild,
            args: [forwardRef(() => EmojiListComponent)]
        }], inputAutofocus: [{
            type: Input,
            args: ['inputAutofocus']
        }] }); })();
...
class EmojiPickerComponent {
    ...
    constructor(_renderer, _el) {
        ...
        this._windowResize = new Subject$1();
    ...
    setPosition(target, directionCode = DIRECTIONS.bottom) {
        ...
        const /** @type {?} */ targetBorders = target.nativeElement.getBoundingClientRect(), /** @type {?} */
        thisBorders = this._el.nativeElement.getBoundingClientRect();
        let /** @type {?} */ heightCorrection = 0, /** @type {?} */ widthCorrection = 0;
...
EmojiPickerComponent.ɵfac = function EmojiPickerComponent_Factory(t) { return new (t || EmojiPickerComponent)(ɵngcc0.ɵɵdirectiveInject(Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef)); };
EmojiPickerComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiPickerComponent, selectors: [["emoji-picker"]], hostBindings: function EmojiPickerComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("mousedown", function EmojiPickerComponent_mousedown_HostBindingHandler($event) { return ctx.onBackground($event); }, false, ɵngcc0.ɵɵresolveDocument)("mousedown", function EmojiPickerComponent_mousedown_HostBindingHandler($event) { return ctx._lastHostMousedownEvent = $event; })("resize", function EmojiPickerComponent_resize_HostBindingHandler($event) { return ctx._windowResize.next($event); }, false, ɵngcc0.ɵɵresolveWindow);
    } }, outputs: { selectionEmitter: "emoji-select", pickerCloseEmitter: "picker-close" }, decls: 1, vars: 1, consts: [[3, "inputAutofocus", "emoji-selection"]], template: function EmojiPickerComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵproperty("inputAutofocus", ctx.emojiPickerAutofocus);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiPickerComponent, [{
        type: Component,
        args: [{
  ...
  `,
    ...
    }], function () { return [{ type: Renderer2 }, { type: ɵngcc0.ElementRef }]; }, { selectionEmitter: [{
            type: Output,
            args: ['emoji-select']
        }], pickerCloseEmitter: [{
            type: Output,
...
EmojiHeaderComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiHeaderComponent, selectors: [["emoji-header"]], inputs: { emojisCategories: "emojisCategories", inputAutofocus: "inputAutofocus" }, outputs: { categorySelection: "categorySelection", searchEmitter: "search" }, decls: 2, vars: 2, consts: [[3, "emojisCategories", "categorySelection"], [3, "inputAutofocus", "search"]], template: function EmojiHeaderComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(1);
        ɵngcc0.ɵɵproperty("inputAutofocus", ctx.inputAutofocus);
    } }, directives: function () { return [EmojiCategoriesComponent, EmojiSearchComponent]; }, styles: ["[_nghost-%COMP%] {  display: block;  border-bottom: 1px solid #F9F9F9;  border-radius: 3px 3px 0 0;  padding: 10px;  background: #FCFCFC; }"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiHeaderComponent, [{
        type: Component,
        args: [{
...
class EmojiSearchComponent {
    ...
    constructor(_renderer) {
        this._renderer = _renderer;
        this.searchEmitter = new EventEmitter();
        this._searchValue = new Subject$1();
        this._destroyed = new Subject$1();
        this._searchValue
            .takeUntil(this._destroyed)
            .subscribe(value => {
...
EmojiSearchComponent.ɵfac = function EmojiSearchComponent_Factory(t) { return new (t || EmojiSearchComponent)(ɵngcc0.ɵɵdirectiveInject(Renderer2)); };
EmojiSearchComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiSearchComponent, selectors: [["emoji-search"]], viewQuery: function EmojiSearchComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 5);
    } if (rf & 2) {
        let _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.input = _t.first);
    } }, inputs: { inputAutofocus: "inputAutofocus" }, outputs: { searchEmitter: "search" }, decls: 2, vars: 0, consts: [["type", "text", "autocomplete", "off", "placeholder", "Search", 3, "input"], ["input", ""]], template: function EmojiSearchComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵelementEnd();
    } }, styles: ["input[_ngcontent-%COMP%] {  width: 100%;  padding: 5px 10px;  border: 1px solid #F0F0F0;  outline: none;  font-size: 14px;  font-weight: inherit;  box-sizing: border-box; }  input[_ngcontent-%COMP%]:focus {    border-color: #d7d7d7; }"] });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiSearchComponent, [{
        type: Component,
        args: [{
                selector: 'emoji-search',
                styles: ['input {  width: 100%;  padding: 5px 10px;  border: 1px solid #F0F0F0;  outline: none;  font-size: 14px;  font-weight: inherit;  box-sizing: border-box; }  input:focus {    border-color: #d7d7d7; }'],
                template: `
  <input type="text" autocomplete="off" #input (input)="handleInputChange($event.target.value)" placeholder="Search"/>
  `
            }]
    }], function () { return [{ type: Renderer2 }]; }, { searchEmitter: [{
            type: Output,
            args: ['search']
        }], inputAutofocus: [{
            type: Input,
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiCategoriesComponent, [{
        type: Component,
        args: [{
...
EmojiFooterComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: EmojiFooterComponent, selectors: [["emoji-footer"]], decls: 1, vars: 0, consts: [[1, "emoji-footer"]], template: function EmojiFooterComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiFooterComponent, [{
        type: Component,
        args: [{
...
class EmojiPickerApiDirective {
    ...
    constructor(_cfr, _vcr, _el) {
        ...
        this._emojiPickerOpenState = new Subject$1();
        this._destroyed = new Subject$1();
        this._emojiSubs = [];
    ...
    recordSelection() {
        ...
        if (window.getSelection) {
            let /** @type {?} */ sel = window.getSelection();
...
EmojiPickerApiDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: EmojiPickerApiDirective, selectors: [["", "emojiPickerIf", ""]], hostBindings: function EmojiPickerApiDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("mousedown", function EmojiPickerApiDirective_mousedown_HostBindingHandler($event) { return $event.emojiPickerExempt = true; });
    } }, inputs: { emojiPickerDirection: "emojiPickerDirection", emojiPickerIf: "emojiPickerIf", emojiPickerPreserveSelection: "emojiPickerPreserveSelection", emojiPickerAutofocus: "emojiPickerAutofocus" }, outputs: { emojiPickerIfEmitter: "emojiPickerIfChange", selectEmitter: "emojiPickerSelect" } });
/** @nocollapse */
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiPickerApiDirective, [{
        type: Directive,
        args: [{
            ...
            type: Input,
            args: ['emojiPickerIf']
        }], emojiPickerPreserveSelection: [{
            type: Input,
            args: ['emojiPickerPreserveSelection']
        }], emojiPickerAutofocus: [{
            type: Input,
            args: ['emojiPickerAutofocus']
        }] }); })();
...
class EmojiPickerCaretDirective {
    ...
    constructor(_el) {
        ...
        this._caretEvent$ = new Subject$1();
        this._destroyed$ = new Subject$1();
     ...
     */
    updateCaretPosition() {
        const /** @type {?} */ cEvent = CaretEvent.generateCaretEvent(this.win, this.doc, this._el.nativeElement);
    ...
    updateCaretDueMutation() {
        const /** @type {?} */ cEvent = CaretEvent.generateCaretEvent(this.win, this.doc, this._el.nativeElement);
        let /** @type {?} */ textMovement = cEvent.textContent.length - this._lastCaretEvent.textContent.length;
...
EmojiPickerCaretDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: EmojiPickerCaretDirective, selectors: [["", "emojiPickerCaretEmitter", ""]], hostBindings: function EmojiPickerCaretDirective_HostBindings(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiPickerCaretDirective, [{
        type: Directive,
        args: [{
...
EmojiEmptyCategoryPipe.ɵpipe = /*@__PURE__*/ ɵngcc0.ɵɵdefinePipe({ name: "notEmptyEmojiCategory", type: EmojiEmptyCategoryPipe, pure: true });
/** @nocollapse */
EmojiEmptyCategoryPipe.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiEmptyCategoryPipe, [{
        type: Pipe,
        args: [{
...
EmojiPickerModule.ɵfac = function EmojiPickerModule_Factory(t) { return new (t || EmojiPickerModule)(); };
EmojiPickerModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: EmojiPickerModule });
EmojiPickerModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ providers: [], imports: [[
            CommonModule
        ]] });
/** @nocollapse */
EmojiPickerModule.ctorParameters = () => [];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(EmojiPickerModule, [{
        type: NgModule,
        args: [{
                imports: [
                    CommonModule
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(EmojiPickerModule, { declarations: function () { return [EmojiEmptyCategoryPipe, EmojiPickerApiDirective, EmojiPickerCaretDirective, EmojiButtonComponent, EmojiContentComponent, EmojiPickerComponent, EmojiListComponent, EmojiHeaderComponent, EmojiSearchComponent, EmojiCategoriesComponent, EmojiCategoryComponent, EmojiFooterComponent]; }, imports: function () { return [CommonModule]; }, exports: function () { return [EmojiPickerApiDirective, EmojiPickerCaretDirective, EmojiButtonComponent, EmojiContentComponent, EmojiPickerComponent, EmojiListComponent, EmojiHeaderComponent, EmojiSearchComponent, EmojiCategoriesComponent, EmojiCategoryComponent, EmojiFooterComponent]; } }); })();
