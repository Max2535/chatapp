(function (global, factory) {
	...
	(factory((global.ng = global.ng || {}, global.ng.ng2EmojiPicker = {}),global.ng.core,global.ng.common,global.Rx));
...
Observable_1$1.Observable.prototype.takeUntil = takeUntil_1.takeUntil;

"use strict";
var Observable_1$2 = require('../../Observable');
var throttleTime_1 = require('../../operator/throttleTime');
Observable_1$2.Observable.prototype.throttleTime = throttleTime_1.throttleTime;

"use strict";
var Observable_1$3 = require('../../Observable');
var distinctUntilChanged_1 = require('../../operator/distinctUntilChanged');
Observable_1$3.Observable.prototype.distinctUntilChanged = distinctUntilChanged_1.distinctUntilChanged;
...
var EmojiPickerOptions = (function () {
     ...
     * @return {?}
     */
    EmojiPickerOptions.prototype.setEmojiSheet = /**
     * @param {?} config
     * @return {?}
     */
    function (config) {
...
var CaretEvent = (function () {
     ...
     */
    function (e1, e2) {
        var /** @type {?} */ changed = /** different when either caretRange is omitted while other exists */
    ...
    function (win, doc, element) {
        var /** @type {?} */ caretOffset = 0;
        var /** @type {?} */ sel;
        var /** @type {?} */ caretRange;
        var /** @type {?} */ textContent = element.textContent;
        ...
        if (typeof win.getSelection !== "undefined") {
            ...
            if (sel.rangeCount > 0) {
                var /** @type {?} */ range = win.getSelection().getRangeAt(0);
                var /** @type {?} */ preCaretRange = range.cloneRange();
                var /** @type {?} */ nodeLength = element.textContent.length;
            ...
            var /** @type {?} */ textRange = sel.createRange();
            var /** @type {?} */ preCaretTextRange = doc.body.createTextRange();
...
var EmojiCategoryComponent = (function () {
    function EmojiCategoryComponent(element) {
...
var EmojiContentComponent = (function () {
    ...
    function (value) {
        var _this = this;
        var /** @type {?} */ filteredEmojis = this.emojisCategories.map(function (category) { return Object.assign({}, category, { emojis: [] }); });
        value = value.replace(/-/g, '').toLowerCase();
        Object.keys(this._emojis).forEach(function (i) {
            var /** @type {?} */ category = _this._emojis[i];
    ...
    EmojiContentComponent.propDecorators = {
        ...
        "emojiSelectionEmitter": [{ type: core.Output, args: ['emoji-selection',] },],
        "inputAutofocus": [{ type: core.Input, args: ['inputAutofocus',] },],
    };
...
var EmojiPickerComponent = (function () {
    function EmojiPickerComponent(_renderer, _el) {
        ...
        this._windowResize = new Subject.Subject();
    ...
    function (target, directionCode) {
        ...
        var /** @type {?} */ targetBorders = target.nativeElement.getBoundingClientRect(), /** @type {?} */
        thisBorders = this._el.nativeElement.getBoundingClientRect();
        var /** @type {?} */ heightCorrection = 0, /** @type {?} */ widthCorrection = 0;
     ...
     * @return {?}
     */
    EmojiPickerComponent.prototype.setAutofocus = /**
     * @param {?} value
     * @return {?}
     */
    function (value) {
...
var EmojiSearchComponent = (function () {
    function EmojiSearchComponent(_renderer) {
        ...
        this._renderer = _renderer;
        this.searchEmitter = new core.EventEmitter();
        this._searchValue = new Subject.Subject();
        this._destroyed = new Subject.Subject();
        this._searchValue
            .takeUntil(this._destroyed)
     ...
     * @return {?}
     */
    EmojiSearchComponent.prototype.ngAfterViewInit = /**
     * @return {?}
     */
    function () {
...
var EmojiPickerApiDirective = (function () {
    function EmojiPickerApiDirective(_cfr, _vcr, _el) {
        ...
        this._emojiPickerOpenState = new Subject.Subject();
        this._destroyed = new Subject.Subject();
        this._emojiSubs = [];
     ...
     * @return {?}
     */
    EmojiPickerApiDirective.prototype.recordSelection = /**
     * @return {?}
     */
    function () {
     ...
     * @return {?}
     */
    EmojiPickerApiDirective.prototype.restoreSelection = /**
     * @return {?}
     */
    function () {
    ...
    EmojiPickerApiDirective.propDecorators = {
        "emojiPickerPreserveSelection": [{ type: core.Input, args: ['emojiPickerPreserveSelection',] },],
        "emojiPickerIfEmitter": [{ type: core.Output, args: ['emojiPickerIfChange',] },],
        "selectEmitter": [{ type: core.Output, args: ['emojiPickerSelect',] },],
        "emojiPickerAutofocus": [{ type: core.Input, args: ['emojiPickerAutofocus',] },],
...
var EmojiPickerCaretDirective = (function () {
    function EmojiPickerCaretDirective(_el) {
        ...
        this._caretEvent$ = new Subject.Subject();
        this._destroyed$ = new Subject.Subject();
     ...
     */
    function () {
        var /** @type {?} */ cEvent = CaretEvent.generateCaretEvent(this.win, this.doc, this._el.nativeElement);
    ...
    function () {
        var _this = this;
        var /** @type {?} */ cEvent = CaretEvent.generateCaretEvent(this.win, this.doc, this._el.nativeElement);
        var /** @type {?} */ textMovement = cEvent.textContent.length - this._lastCaretEvent.textContent.length;
...
exports.EmojiPickerOptions = EmojiPickerOptions;
exports.EmojiPickerAppleSheetLocator = EmojiPickerAppleSheetLocator;
...
//# sourceMappingURL=ng2-emoji-picker.umd.js.map
